      ...
      {submitted ? (
        <div className="text-center py-6 space-y-4">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 max-w-xs mx-auto">
            Instructions sent to <strong className="text-brand-500">{email}</strong>.
          </p>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Enter your Taskora account email to receive a password reset link.
          </p>
          <div>
          ...
          <div className="pt-4 flex justify-end gap-3 border-t border-gray-100 dark:border-gray-800">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2.5 rounded-2xl text-xs font-bold bg-gradient-brand text-white shadow-brand"
            >
