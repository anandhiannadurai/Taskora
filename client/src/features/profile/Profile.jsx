    ...
    <div className="max-w-4xl space-y-8 pb-12 animate-in fade-in duration-300">
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-dark-card border border-gray-100 dark:border-gray-800 shadow-soft space-y-6">
        <h3 className="text-base font-extrabold text-gray-900 dark:text-white flex items-center gap-2">
          <User className="w-5 h-5 text-brand-500" /> Update Profile
        </h3>
        ...
        <form onSubmit={handleProfileSubmit} className="space-y-4">
          ...
          <div className="flex justify-end pt-2">
            <button
              ...
              className="px-6 py-2.5 rounded-2xl text-xs font-bold bg-gradient-brand text-white shadow-brand hover:opacity-95 flex items-center gap-2"
            >
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-dark-card border border-gray-100 dark:border-gray-800 shadow-soft space-y-6">
        ...
        <form onSubmit={handlePasswordSubmit} className="space-y-4 max-w-md">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-2xl text-xs font-bold bg-gray-900 dark:bg-gray-800 text-white hover:bg-black flex items-center gap-2"
          >
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-dark-card border border-gray-100 dark:border-gray-800 shadow-soft space-y-6">
        <h3 className="text-base font-extrabold text-gray-900 dark:text-white flex items-center gap-2">
          <Bell className="w-5 h-5 text-brand-500" /> Notification Settings & Dark Mode
        </h3>

        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 dark:bg-dark-bg/60">
            <div>
              <h4 className="text-xs font-bold text-gray-900 dark:text-white">Dark Mode Toggle</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400">Switch dark slate background and high contrast typography</p>
            </div>
            <button
          ...
          <div className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 dark:bg-dark-bg/60">
            <div>
              <h4 className="text-xs font-bold text-gray-900 dark:text-white">Email & Push Notifications</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400">Receive alerts on project status and focus sprint completion</p>
            </div>
            <input
              type="checkbox"
